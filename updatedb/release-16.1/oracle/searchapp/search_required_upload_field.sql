...
grant select,delete,insert,update on searchapp.search_required_upload_field to biomart_user
/
grant all on searchapp.search_required_upload_field to tm_cz
/
